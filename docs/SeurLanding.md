...
## Typography refinement — September 12, 2026

Replaced the editorial serif/italic treatment with one upright system sans-serif family across headlines, navigation, captions, cards and the wordmark. On Apple devices this follows the native system type. Headlines use semibold weight, calmer sizing and restrained tracking; a muted color provides secondary emphasis without switching type styles. Decorative emphasis uses spans rather than semantic italics. Updated the responsive title sizes and retained the line-by-line entry animations and reduced-motion rules. App screenshots remain unchanged.
