...
The native **Seur iOS 26 SwiftUI app** is now in [`iOS/`](iOS/README.md). Open `iOS/Seur.xcodeproj` in Xcode. It uses Apple Liquid Glass, native zoom navigation, haptic feedback, and the bundled hotel/dining catalog.
